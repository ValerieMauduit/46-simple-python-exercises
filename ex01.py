...
numbers passed to the max() function.
To test the function, change its name (e.g., max1() or max2()) as a max()
function already exists.'''

# print('{} is the largest number'.format(max(2, 8)))
# print('{} is the largest number'.format(max(6.8, 0.3)))
